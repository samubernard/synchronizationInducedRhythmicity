function y=BWntStoch(t,x,sc0,K);
% BWNTSTOCH version of BWNT with noisy frequency and coupling
...
coupling=K*(v.*cn); % multiplicative noise
% coupling=K*v+mean(v)*(cn-1); % additive noise
...
y(11:NV:NV*N) = -0.05*(sc-sc0);                           % frequency
y(12:NV:NV*N) = -0.1*(cn-1);                              % coupling noise
